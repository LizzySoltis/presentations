...
Follow these guidelines to best use GitHub icons and illustrations within a presentation. Approved visual assets are provided within the [asset library](https://primer.style/presentations/assets/icon-packages).

<DoDontContainer>
  <Dont>
    <Text>Alter the illustrations</Text>
  </Dont>
  <Dont>
    <Text>Combine images that use different stylings</Text>
  </Dont>
</DoDontContainer>
...
| Step                                                                            | Example                                                                                                                                                            |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| 1. Open [GitHub-keynote-icons.key](https://primer.style/presentations/presentation-formats/keynote)  | <img width="500" alt="Screenshot 2019-03-18 13 35 39" src="https://user-images.githubusercontent.com/10384315/54571249-13a94980-499f-11e9-9643-1401534922d4.png"/> |
